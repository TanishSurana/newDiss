...
class CrossPairwiseImg(data.Dataset):
    def __init__(self, root, joint_transform=None, img_transform=None, target_transform=None):
        ...
        print(self.img_root, self.video_root)
    ...
    def __getitem__(self, index):
        ...
        # can generate 4 index directly, index, query_index, other_index
        ...
        #     print('random frame: ',other_index, other_path, other_gt_path, videoStartIndex3, videoLength3)
        #     print('first frame', index, exemplar_path, exemplar_gt_path, videoStartIndex, videoLength)
        #     raise TypeError('Something wrong')
