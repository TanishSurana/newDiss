...
parser.add_argument('--batchsize', type=int, default=3, help='train batch')
...
log_path = os.path.join(ckpt_path, exp_name, str(datetime.datetime.now()).replace(':', "-") + '.txt')
val_log_path = os.path.join(ckpt_path, exp_name, 'val_log' + str(datetime.datetime.now()).replace(':', "-") + '.txt')
